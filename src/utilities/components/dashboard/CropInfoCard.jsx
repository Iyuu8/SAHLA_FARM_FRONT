...
export default function CropInfoCard({
  ...
  useEffect(() => {
    const getTranslation = async () => {
      // Determine which text to translate based on the condition
      const rawText = hasSemiAuto 
      ...
      // Await the actual translation
      const result = await translateText(rawText, i18n.language);
      setDynamicText(result);
    };

    getTranslation();
  }, [hasSemiAuto, i18n.language]);
